...
### 개선할점 및 느낀점
처음으로 Git markdown과 함께 글을 작성하다보니 낯설고 술술 풀리지 않았으나 1주차 ~ 18주차까지 진행하면 금방 익힐 수 있을거라 생각한다. java는 사용하고 있지만 정확한 개념없이 사용하는 경우가 많았는데 글을 정리하며 작성하다보니 새롭게 알게된 개념과 원래 알고있던 개념을 자세하게 알 수 있었어 뿌듯했다.
18주차까지 천천히 반복학습!!
